  ...
  return (
    <div className="flex w-full items-center bg-slate-50 px-48 py-12 h-screen/66">
      <div className="w-full flex flex-col h-full justify-around mx-20 px-4 py-16">
        ...
        <button className="font-sans p-4 bg-rose-300 rounded text-white hover:bg-pink-50 hover:text-rose-300 border-2 border-slate-100 hover:border-rose-300 text-center w-fit self-start">
          Learn more
        </button>
      </div>
